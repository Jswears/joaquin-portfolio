    ...
    return (
        <section className="p-6 pt-[200px] flex flex-col justify-between items-center">
            ...
            <div className="flex gap-4">
                <button type="submit" className="text-sm font-bold border-[#252525] border px-8 py-[14px] rounded-lg">View Work</button>
                <button type="submit" className="text-sm font-bold border-[#252525] border px-8 py-[14px] rounded-lg">Contact Me</button>
            </div>
        </section>
    );
}
