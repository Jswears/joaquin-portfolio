...
const Navbar = () => {
    ...
    return (
        <header
            className={`h-[100px] p-6 fixed w-full transition-all duration-500 ease-in-out ${!showNavbar ? "-top-44 transition ease-in delay-100" : "top-0 transition ease-in delay-75 shadow-md"} ${navbarOffSet === 0 ? "bg-none shadow-none backdrop-blur-0" : 'backdrop-blur-sm'}`}
            ref={navbarRef}
        >
